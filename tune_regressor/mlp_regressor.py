...
from typing import Optional, Dict, Any, Callable, Iterable, Union
...
#         params["hidden_layer_sizes"] = tuple(trial.suggest_int("hidden_layer_sizes", 
...
#         params = self._sample_params(trial)
#         model = super()._evaluate_sampled_model("regression", MLPRegressor, params)
#         self.model = model
#         return model
